...
There was nothing so _very_ remarkable in that; nor did
Alice think it so _very_ much out of the way to hear the
...
natural); but when the Rabbit actually _took a watch out of its
waistcoat-pocket,_ and looked at it, and then hurried on,
...
./SedIsForLosers test Alice Bob

echo "./SedIsForLosers test Alice Bob"
